package com.link_up.matching_manager.data.model

import com.google.gson.annotations.SerializedName

data class ArenaResponse(
    @SerializedName("meta") val meta: com.link_up.matching_manager.data.model.MetaResponse?,
    @SerializedName("documents") val documents: List<com.link_up.matching_manager.data.model.DocumentsResponse>?
)
...
data class MetaResponse(
    ...
    // 질의어의 지역 및 키워드 분석 정보
    @SerializedName("same_name") val sameName: com.link_up.matching_manager.data.model.SameNameResponse?
)

data class SameNameResponse(
    // 질의어에서 인식된 지역의 리스트 ( 예: '중앙로 맛집' 에서 중앙로에 해당하는 지역 리스트 )
    @SerializedName("region") val region: Array<String>?,
