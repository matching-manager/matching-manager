...
import com.example.matching_manager.ui.my.MyTeamApplicationEditActivity.Companion.editIntent
...
class MyTeamApplicationMenuBottomSheet(private val item : TeamItem.ApplicationItem) : BottomSheetDialogFragment() {
    ...
    private fun initView() = with(binding) {
        ...
        tvRemove.setOnClickListener {
            ...
            dialog.setOnDismissListener(object : MyTeamApplicationDeleteDialog.OnDialogDismissListener {
