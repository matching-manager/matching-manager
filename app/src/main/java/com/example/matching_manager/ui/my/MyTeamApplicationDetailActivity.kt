...
import com.example.matching_manager.databinding.MyTeamApplicationDetailActivityBinding
...
class MyTeamApplicationDetailActivity : AppCompatActivity() {

    private lateinit var binding : MyTeamApplicationDetailActivityBinding
    ...
    companion object {
        ...
        fun detailIntent(
            ...
            val intent = Intent(context, MyTeamApplicationDetailActivity::class.java)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = MyTeamApplicationDetailActivityBinding.inflate(layoutInflater)
